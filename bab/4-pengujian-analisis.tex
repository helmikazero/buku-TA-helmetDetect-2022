...
\par Pada bagian ini akan dipaparkan dan dibandingkan performa antara tiap bobot yang dihasilkan 
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{gambar/final_weight_val/hedec_pretrain-no_helmet.png}
  \caption{Grafik \emph{Precision, Recall, mAP} untuk Bobot Hasil Pretrain COCO-YOLOv5 untuk Kelas "no\_helmet"}
  \label{fig:grafval_pretrain_no_helmet}  
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{gambar/final_weight_val/hedec_pretrain-with_helmet.png}
  \caption{Grafik \emph{Precision, Recall, mAP} untuk Bobot Hasil Pretrain COCO-YOLOv5 untuk Kelas "with\_helmet"}
  \label{fig:grafval_pretrain_with_helmet}  
\end{figure}

\par Berdasarkan hasil validasi yang dipaparkan, tidak ada perbedaan signifikan dari \emph{precision, recall, mAP} 
baik pada kelas "with\_helmet" seperti yang ditunjukan pada Gambar~\ref{fig:grafval_pretrain_with_helmet} ataupun "no\_helmet" pada Gambar~\ref{fig:grafval_pretrain_no_helmet}.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{gambar/final_weight_val/hedec_pure-no_helmet.png}
  \caption{Grafik \emph{Precision, Recall, mAP} untuk Bobot Tanpa Pretrain COCO-YOLOv5 untuk Kelas "no\_helmet"}
  \label{fig:grafval_pure_no_helmet}  
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{gambar/final_weight_val/hedec_pure-with_helmet.png}
  \caption{Grafik \emph{Precision, Recall, mAP} untuk Bobot Tanpa Pretrain COCO-YOLOv5 untuk Kelas "with\_helmet"}
  \label{fig:grafval_pure_with_helmet}  
\end{figure}

\par Berdasarkan hasil validasi
