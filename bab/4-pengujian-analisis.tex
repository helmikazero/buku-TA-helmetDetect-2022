...
\begin{enumerate}
  ...
  \begin{figure} [h!]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/train_v2_val/low_ligjt/customMedium/val_batch0_pred.jpg}
...
\input{bab/4_3-analisisarah.tex}
\input{bab/4_2-analisissistem.tex}
