...
\section{Peraturan Menteri Pekerjaan Umum dan Perumahan Rakyat tentang Pedoman Sistem Manajemen Keselamatan Konstruksi}
...
\par Proses penyelesain deteksi objek biasanya dilakukan dalam 3 tahap yaitu pemilihan wilayah informatif, ekstraksi fitur, dan
klasifikasi.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{gambar/pooling.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width= 0.9\textheight, angle =90]{gambar/yolov5 structure.png}
